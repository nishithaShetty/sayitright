             ...
             while($row = mysqli_fetch_array($result))
             {
               ?>
                 ...
                 <tr>
                  ...
                  <td> <a href="includes/edit.php?edit=<?php echo $row['id'];?>" class ="btn btn-info">Edit</a>
                      
                      <a href="includes/delete.php?delete=<?php echo $row['id'];?>" class ="btn btn-danger">Delete</a>
...
?>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>
                                 <a href="includes/add.php?add=<?php echo $row['id'];?>" class ="btn btn-info">Add</a> </td>
                    </tr>
