...
$sql = "UPDATE events
     SET events_name = '$name', description= '$description', date='$date', sede='$sede', confirmation='$confirmation'
WHERE id = $id;";
...
<body>
	...
	<div class="first">
      ...
      Events Name :<input type="text" name="name" value="<?php echo $row['events_name']  ?>"><br>
